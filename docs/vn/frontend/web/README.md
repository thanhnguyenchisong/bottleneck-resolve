...
Bộ tài liệu **nền tảng web** không phụ thuộc framework: **CSS**, **SCSS/Sass**, **Responsive Web Design**, **Reactive Programming**, **Accessibility**, **Performance**, **Browser/DOM**, **Security**. Học xong kết hợp với [frontend (Angular)](../frontend/) để **đi phỏng vấn senior front-end pass ngay**.
